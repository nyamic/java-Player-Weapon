...
public class 헤일리 extends Player{
	...
	public void 머리빗기(BattleView view) {
		view.appendLog("헤일리가 [머리 빗기] 스킬을 사용했습니다.", "reset");
		view.appendLog("헤일리 : 싸울 때는 머리가 망가져서 싫단 말이야~ 이제야 내 머릿결이 좀 볼만해졌네!", "reset");
		view.appendLog("헤일리가 머리 정리로 자신감이 올라갔습니다. 헤일리의 power가 20 증가합니다.", "reset");
	...
	public void 거울보기(BattleView view) {
        ...
        view.appendLog("헤일리가 [거울 보기] 스킬을 사용했습니다.", "reset");
		view.appendLog("헤일리 : 아임 어 뷰티풀 걸! 미모는 나의 무기! 너희들도 내 무기 나눠줄게~", "reset");
		view.appendLog("헤일리가 본인의 미모를 이용해 같은 팀의 power를 15씩 증가시킵니다.", "reset");
