...
public class 하비 extends Player{
	...
	public void 책읽기(BattleView view) {
		view.appendLog("하비가 [책 읽기] 스킬을 사용했습니다.");
		view.appendLog("하비 : 역시 마음 안정에는 책만 한 게 없지. 다시 여유로워졌어!");
		view.appendLog("하비가 책을 읽으며 안정을 찾았습니다. 하비의 Hp가 20 증가합니다.");
	...
	public void 공부하기(BattleView view) {
        ...
        view.appendLog("하비가 [공부하기] 스킬을 사용했습니다.");
		view.appendLog("하비 : 오호, 이렇게도 사람들을 치유할 수 있군!!");
		view.appendLog("하비가 새로운 치료술을 학습했습니다. 같은 팀원들의 Hp를 즉시 30 회복시켜줍니다.");
