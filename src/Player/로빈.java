...
public class 로빈 extends Player{
	...
	public void 가구만들기(BattleView view) {			
		view.appendLog("로빈이 [가구 만들기] 스킬을 사용합니다.", "reset");
		view.appendLog("로빈 : 안되겠어. 가구를 만들어서 방어막으로 사용해야겠어(뚝딱뚝딱)", "reset");
		view.appendLog("로빈이 가구들로 방어막을 만들었습니다. 로빈의 Hp가 50 증가합니다.", "reset");
	...
	public void 장작패기(BattleView view) {
        ...
        view.appendLog("로빈이 [장작 패기] 스킬을 사용합니다.", "reset");
		view.appendLog("어이쿠! 실수로 장작이 저기까지 날아갔네??", "reset");
		view.appendLog("로빈의 장작이 날아가서 모두에게 상처를 냈습니다. 상대 팀원들의 hp가 10씩 감소합니다.", "reset");
